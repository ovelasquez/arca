...
class RevSliderSliderOverview
{
    public function getTemplate(array $args = array())
    {
        ...
        <div class='wrap'>
            ...
            <div class="title_line nobgnopd" style="height:auto; min-height:50px">
                <div class="view_title">
                    <?php echo t("Revolution Sliders Drupal 7.x") ?>
                </div>
            ...
            $template_seg = new RevSliderSlidersList();
            ...
            <div style="width:100%;height:40px;background: #e1e1e1;"></div>
        ...
        <?php
        $template_seg = new RevSliderSliderSelector();
