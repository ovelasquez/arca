 ...
 * Time: 9:02 AM
 */
class RevSliderSettingsPanelRight
{
                            ...
                            <div id="general-progressbar" style="display:none">
                                ...
                                <div id="progressbar_settings">
                                    ...
                                    <input type="text"
                                           ...
                                           value="<?php echo RevSliderTPColorpicker::convert(RevSliderFunctions::getVal($arrFieldsParams, 'progressbar_color', 'rgba(0,0,0,0.15)'), RevSliderFunctions::getVal($arrFieldsParams, 'progress_opa', 'false')); ?>"/>
                                    <script>
                                        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            <div id="navigation-thumbnails" style="display:none;">
                                ...
                                <div id="nav_thumbnails_subs">
                                    ...
                                    <input type="text"
                                           ...
                                           value="<?php echo RevSliderTPColorpicker::convert(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_wrapper_color', 'transparent'), RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_wrapper_opacity', false)); ?>"/>
                                    <div class="clear"></div>
                            ...
                            <div id="navigation-tabs" style="display:none;">
                                ...
                                <div id="nav_tabs_subs">
                                    ...
                                    <input type="text"
                                           ...
                                           value="<?php echo RevSliderTPColorpicker::convert(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_wrapper_color', 'transparent'), RevSliderFunctions::getVal($arrFieldsParams, 'tabs_wrapper_opacity', false)); ?>"/>
                                    <div class="clear"></div>
