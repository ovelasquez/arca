 ...
 * Time: 6:50 PM
 */
class RevSliderSlideEditorHelper
{
...
// Set params to views twig
        ...
        $response = RevSliderFunctions::array_merge_multi_level($response, RevSliderSectionVariable::slide_editor_scripts_library(array(
            'slider' => $slider
        )));
        $response = RevSliderFunctions::array_merge_multi_level($response, RevSliderSectionVariable::dialog_copy_move(array(
            'selectSliders' => $selectSliders
        )));
        $response = RevSliderFunctions::array_merge_multi_level($response, RevSliderSectionVariable::breadcrumbs(array(
            'sliderTemplate' => $sliderTemplate,
            'sliderID'       => $sliderID,
            'slider'         => $slider,
            'slide'          => $slide
        )));
        $response = RevSliderFunctions::array_merge_multi_level($response, RevSliderSectionVariable::slide_selector(array(
            "slideID"     => $slideID,
            "slider"      => $slider,
            "slide"       => $slide,
        ...
        $response = RevSliderFunctions::array_merge_multi_level($response, RevSliderSectionVariable::slide_general_settings(array(
        ...
        $response = RevSliderFunctions::array_merge_multi_level($response, RevSliderSectionVariable::html_id_esw(array(
