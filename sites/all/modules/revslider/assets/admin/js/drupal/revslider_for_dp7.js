if (typeof (Drupal.settings.revslider) !== 'undefined') {
    var RS_DEMO = Drupal.settings.revslider.RS_DEMO;
    var ajaxurl = Drupal.settings.revslider.ajaxurl;
    var g_revNonce = Drupal.settings.revslider.g_revNonce;
    var g_uniteDirPlugin = Drupal.settings.revslider.g_uniteDirPlugin;
    var g_urlContent = Drupal.settings.revslider.g_urlContent;
    var g_urlAjaxShowImage = Drupal.settings.revslider.g_urlAjaxShowImage;
    var g_urlAjaxActions = Drupal.settings.revslider.g_urlAjaxActions;
    var g_revslider_url = Drupal.settings.revslider.g_revslider_url;
    var g_settingsObj = Drupal.settings.revslider.g_settingsObj;
    var rs_pack_page_creation = Drupal.settings.revslider.rs_pack_page_creation;
    var rs_single_page_creation = Drupal.settings.revslider.rs_single_page_creation;
    var tp_color_picker_presets = Drupal.settings.revslider.tp_color_picker_presets;
    var global_grid_sizes = Drupal.settings.revslider.global_grid_sizes;
    var wpColorPickerL10n = Drupal.settings.revslider.wpColorPickerL10n;
    var thickboxL10n = Drupal.settings.revslider.thickboxL10n;
    if (typeof(rev_lang) == 'undefined') {
        rev_lang = Drupal.settings.revslider.javascript_multilanguage;
    }
}
